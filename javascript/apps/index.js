const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./assets/index-BIpNQ4vD.js","./assets/page_mf_2_insights__loadShare__react__loadShare__-BOGI0a0r.js","./assets/_commonjsHelpers-CUmg6egw.js","./assets/page_mf_2_insights__mf_v__runtimeInit__mf_v__-joFqPJ2D.js","./assets/index-D_1p4lv2.js","./assets/index-C2jXkER7.js","./assets/react-redux-CPRAtsOR.js"])))=>i.map(i=>d[i]);
import exposesMap from "./assets/virtualExposes-Dc-HsDOB.js";
import { _ as __vitePreload } from "./assets/preload-helper-UZRgTS1n.js";
import { p as page_mf_2_insights__mf_v__runtimeInit__mf_v__ } from "./assets/page_mf_2_insights__mf_v__runtimeInit__mf_v__-joFqPJ2D.js";
var index_cjs$2 = {};
var index_cjs$1 = {};
...
const lazyLoaderHookFetch = async (input, init2, loaderHook2) => {
  const hook = (url2, init22) => {
    return loaderHook2.lifecycle.fetch.emit(url2, init22);
  };
...
async function loadEntryScript({ name, globalName, entry, loaderHook: loaderHook2, getEntryUrl }) {
  ...
  return sdk.loadScript(url2, {
    attrs: {},
    createScriptHook: (url3, attrs2) => {
      const res2 = loaderHook2.lifecycle.createScript.emit({ url: url3, attrs: attrs2 });
      if (!res2)
        return;
  ...
  return sdk.loadScriptNode(entry, {
    ...
    loaderHook: {
      createScriptHook: (url2, attrs2 = {}) => {
        const res2 = loaderHook2.lifecycle.createScript.emit({ url: url2, attrs: attrs2 });
        if (!res2)
          return;
        if ("url" in res2) {
          return res2;
 ...
 ${sdk.safeToString(this.remoteInfo)}`);
  ...
  wraperFactory(moduleFactory, id) {
    function defineModuleId(res2, id2) {
      if (res2 && typeof res2 === "object" && Object.isExtensible(res2) && !Object.getOwnPropertyDescriptor(res2, /* @__PURE__ */ Symbol.for("mf_module_id"))) {
        Object.defineProperty(res2, /* @__PURE__ */ Symbol.for("mf_module_id"), {
          value: id2,
          enumerable: false
        });
      }
...
class SharedHandler {
  ...
  initializeSharing(shareScopeName2 = DEFAULT_SCOPE, extraOptions) {
    ...
    if (from !== "build") {
      ...
      if (!initToken)
        initToken = initTokens2[shareScopeName2] = { from: this.host.name };
    ...
    if (!shareScope[shareScopeName2]) {
      shareScope[shareScopeName2] = {};
    }
    ...
    const initFn = (mod) => mod && mod.init && mod.init(shareScope[shareScopeName2], initScope);
    ...
    Object.keys(host.options.shared).forEach((shareName) => {
      ...
      sharedArr.forEach((shared) => {
        if (shared.scope.includes(shareScopeName2)) {
    ...
    if (host.options.shareStrategy === "version-first" || strategy === "version-first") {
      host.options.remotes.forEach((remote) => {
        if (remote.shareScope === shareScopeName2) {
...
class RemoteHandler {
  ...
  formatAndRegisterRemote(globalOptions, userOptions) {
    ...
    return userRemotes.reduce((res2, remote) => {
      this.registerRemote(remote, res2, { force: false });
      return res2;
...
class ModuleFederation {
  ...
  initRawContainer(name, url2, container) {
    const remoteInfo = getRemoteInfo({ name, entry: url2 });
...
const importMap = {
  "@jahia/ui-extender": async () => {
    let pkg = await __vitePreload(() => import("./assets/index-BIpNQ4vD.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0, import.meta.url);
    return pkg;
  },
  "chart.js": async () => {
    let pkg = await __vitePreload(() => import("./assets/chart-tDRHDrkT.js"), true ? [] : void 0, import.meta.url);
    return pkg;
  },
  "react": async () => {
    let pkg = await __vitePreload(() => import("./assets/index-D_1p4lv2.js").then((n) => n.i), true ? __vite__mapDeps([4,2]) : void 0, import.meta.url);
    return pkg;
  },
  "react-dom": async () => {
    let pkg = await __vitePreload(() => import("./assets/index-C2jXkER7.js").then((n) => n.i), true ? __vite__mapDeps([5,2,1,3]) : void 0, import.meta.url);
    return pkg;
  },
  "react-redux": async () => {
    let pkg = await __vitePreload(() => import("./assets/react-redux-CPRAtsOR.js"), true ? __vite__mapDeps([6,1,2,3]) : void 0, import.meta.url);
    return pkg;
  }
};
const usedShared = {
  "@jahia/ui-extender": {
    ...
    async get() {
      ...
      const res2 = await pkgDynamicImport();
      const exportModule = { ...res2 };
...
const mfName = "page-insights";
async function init(shared = {}, initScope = []) {
  const initRes = init_1({
    name: mfName,
    remotes: usedRemotes,
    shared: usedShared,
    plugins: [FederationWindowPlugin()],
  ...
  page_mf_2_insights__mf_v__runtimeInit__mf_v__.initResolve(initRes);
  return initRes;
}
